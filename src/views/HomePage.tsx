...
const featuredReviews: (Review & { highlight: string })[] = [
  { highlight: 'Car Lockout -- Annapolis', ...(findReview('Desiree Henningsen') ?? allReviews[0]) },
  ...
  { highlight: 'Same-Day Service -- Annapolis', ...(findReview('Debra Kupfer') ?? allReviews[5]) },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "We offer same-day emergency lockout service in the Annapolis area, including Downtown, Eastport, Bay Ridge, and Parole. We dispatch the nearest available technician to minimize your wait time."
  },
  {
  ...
  },
  {
    ...
    answer: "Pricing depends on the type of service needed. We always provide upfront pricing before starting any work -- no hidden fees or surprise charges. Call us for a free quote."
  }
];
  ...
  return (
    <>
      ...
      <section className="py-16 bg-background" aria-label="Detailed locksmith services">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold mb-4">Emergency Locksmith Services in Annapolis, MD</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                We provide mobile locksmith services throughout <strong>Anne Arundel County</strong>. From the <strong>City Dock</strong> to <strong>Severna Park</strong>, we're your trusted local locksmith experts with same-day service available.
              </p>
      ...
      <CallToAction
        ...
        subtitle="Licensed technicians ready to help across Annapolis and Anne Arundel County. Same-day service available."
