...
const services = [
  ...
  { icon: Phone, label: 'Emergency', desc: 'Same-day emergency lockout service', color: 'text-blue-600', border: 'border-b-blue-500' },
...
const faqs = [
  ...
  { question: 'How fast can you reach Edgewater Beach?', answer: 'We are approximately 7 miles from Edgewater Beach and offer same-day service for standard and emergency calls.' },
      ...
      <div className="min-h-screen bg-white">
        <section className="bg-gradient-to-br from-blue-900 to-blue-950 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-4 text-blue-200 text-sm">7 miles from our Annapolis location</p>
          </div>
        </section>
