...
const services = [
  ...
  { title: 'Emergency', description: 'Same-day emergency lockout service', icon: Phone, color: 'bg-red-500' },
...
const faqs = [
  { question: 'How fast can you reach Bay Ridge?', answer: 'Bay Ridge is just 3 miles from our Annapolis location. We offer same-day service.' },
      ...
      <div className="min-h-screen bg-white">
        <section className="relative bg-gradient-to-b from-blue-900 to-blue-950 text-white py-24 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl text-blue-100/80 mb-4 max-w-2xl mx-auto">Professional locksmith services for Bay Ridge, South Annapolis, and the Quiet Waters Park area. Just 3 miles from our Annapolis location.</p>
            ...
            <div className="bg-blue-50 rounded-2xl p-8 md:p-12 border border-blue-100 shadow-lg">
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  { icon: Clock, title: 'Same-Day Service', desc: 'Located just 3 miles from Bay Ridge' },
