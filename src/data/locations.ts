...
export const locations: LocationData[] = [
  {
    ...
    distance: '5.5 miles',
    responseTime: 'Call for availability',
    directions: [
    ...
    faqs: [
      {
        ...
        answer: 'Our mobile locksmiths are based in Annapolis and serve Arnold. We dispatch the nearest available technician to your location.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'We dispatch the nearest available technician to your location in the Edgewater area.'
      }
    ],
    ...
    faqs: [
      {
        ...
        answer: 'We dispatch the nearest available technician to your location in Severna Park.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Since we\u2019re based in Annapolis, we dispatch the nearest available technician to minimize your wait time. Arrival times depend on traffic and time of day.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'We dispatch the nearest available technician to Parole from our Annapolis location.'
      },
      {
    ...
    metaDescription: 'Professional locksmith near Parole & Annapolis Mall. Car lockouts, home rekeying, commercial locks. Licensed & insured. Call (410) 849-6069.'
  },
  {
    id: 'bay-ridge',
    name: 'Bay Ridge, MD',
    ...
    faqs: [
      {
        ...
        answer: 'Yes, Bay Ridge is within our primary service area. We dispatch the nearest available technician to your location.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'We dispatch the nearest available technician to Hillsmere Shores when you call.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Since we\'re based right here, we dispatch the nearest available technician to you anywhere in Eastport.'
      },
      {
    ...
    metaDescription: 'Local Eastport locksmith at 222 Severn Ave. Fast, reliable service. Residential, commercial & marine locksmith services. Call (410) 849-6069.'
  },
  {
    id: 'riva',
    name: 'Riva, MD',
    ...
    faqs: [
      {
        ...
        answer: 'Yes, Riva is well within our service area. We dispatch the nearest available technician to your location.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'We dispatch the nearest available technician to Cape St. Claire from our Annapolis location.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Yes, we provide locksmith services throughout the Broadneck Peninsula. We dispatch the nearest available technician to your location.'
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'We dispatch the nearest available technician to Edgewater Beach when you call.'
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'Yes, Mayo is within our primary service area. We dispatch the nearest available technician to your location.'
      },
      {
