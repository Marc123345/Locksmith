          ...
          <nav className="flex items-center justify-between h-16 md:h-20" role="navigation">
            ...
            <div className="hidden lg:flex items-center space-x-1">
              ...
              >
                ...
                {locationsOpen && (
                  <div className="absolute top-full left-0 mt-1 w-[600px] bg-background border border-border rounded-xl shadow-2xl z-50 overflow-hidden">
              ...
              >
                ...
                {servicesOpen && (
                  <div className="absolute top-full right-0 mt-1 w-[700px] bg-background border border-border rounded-xl shadow-2xl z-50 overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 text-white">
                      <div className="flex items-center gap-2">
